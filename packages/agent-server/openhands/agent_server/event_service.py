...
class EventService:
    ...
    async def start(self):
        ...
        # Setup LLM log/stats streaming (only for OpenHands SDK mode)
        if self._conversation.agent is not None:
