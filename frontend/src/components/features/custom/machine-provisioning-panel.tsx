...
/* eslint-disable no-nested-ternary, i18next/no-literal-string */
...
import {
  ...
  type ProvisionEvent,
} from "#/stores/remote-worker-store";
...
function ProvisionStepItem({
  ...
  return (
    <div
      className="flex gap-2 items-center w-full py-0.5"
      data-name="provision-step"
    >
